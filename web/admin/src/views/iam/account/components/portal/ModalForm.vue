...
/** 对应后端 AccountType.PORTAL + PortalProfileUpsertPayload */
...
async function submitForm() {
  ...
  try {
    // PortalProfileUpsertPayload: name/nickname/avatar/signature/phone/email
    const payload = await buildBaseAccountPayload(state.formModel)
