/*
 Generated from hei-boot/scripts/db.sql via sync-db-mysql-to-stacks.py
 Job seed: job-seed.non-boot.mysql.sql (native handler keys, no sys_job_log)
*/
...
-- Records of sys_job
-- ----------------------------
-- FastAPI / Gin job seed: native handler keys (not Boot Java FQCN).
-- Boot 库保留 github.jiangbyte.io.* 处理器；其他栈各自维护 sys_job 数据。

INSERT INTO `sys_job` VALUES ('7541000000000000001', '示例任务', 'sys_job_sample', 'FIXED', '60', '{}', NULL, '2026-08-16 10:28:57.960251', NULL, 0, '演示调度链路：回显执行参数', 1, '2026-08-16 09:53:26.876522', NULL, '2026-08-16 09:53:26.876522', NULL);
INSERT INTO `sys_job` VALUES ('7541000000000000002', 'Banner 状态同步', 'sys_banner_status_sync', 'FIXED', '60', '{}', NULL, '2026-08-16 10:28:57.970142', NULL, 0, '按 start_at / end_at 激活或过期 Banner', 2, '2026-08-16 09:53:26.882777', NULL, '2026-08-16 09:53:26.882777', NULL);
INSERT INTO `sys_job` VALUES ('7541000000000000003', 'Banner 互动计数刷库', 'sys_banner_flush_interactions', 'FIXED', '60', '{}', NULL, '2026-08-16 10:28:57.962143', NULL, 0, '将 Redis 互动增量写入 sys_banner.interaction_count', 3, '2026-08-16 09:53:26.887732', NULL, '2026-08-16 09:53:26.887732', NULL);
INSERT INTO `sys_job` VALUES ('7541000000000000004', '审计告警', 'sys_audit_alert', 'FIXED', '300', '{}', NULL, '2026-08-16 10:30:56.283976', NULL, 0, '按配置规则扫描审计日志并发送告警', 4, '2026-08-16 09:53:26.892521', NULL, '2026-08-16 09:53:26.892521', NULL);
INSERT INTO `sys_job` VALUES ('7541000000000000006', '注销账号清理', 'iam_account_purge_cancelled', 'CRON', '0 0 3 * * *', '{"retentionDays": 15}', NULL, '2026-08-16 19:00:00.000000', NULL, 0, '每日清理已取消且超过保留期的账号数据', 6, '2026-08-16 09:53:26.897926', NULL, '2026-08-16 09:53:26.897926', NULL);
INSERT INTO `sys_job` VALUES ('7541000000000000007', '审计日志清理', 'sys_audit_log_cleanup', 'CRON', '0 0 4 * * *', '{"batchSize": 1000, "loginRetentionDays": 180, "operationRetentionDays": 365}', NULL, '2026-08-16 20:00:00.000000', NULL, 0, '每日按保留天数清理过期登录与操作审计日志', 7, '2026-08-16 09:53:26.897926', NULL, '2026-08-16 09:53:26.897926', NULL);
INSERT INTO `sys_job` VALUES ('7541000000000000008', '任务执行日志清理', 'sys_job_log_cleanup', 'CRON', '0 30 3 * * *', '{"batchSize": 1000, "retentionDays": 30}', NULL, '2026-08-16 19:30:00.000000', NULL, 0, '按保留天数批量清理过期 sys_job_log', 8, '2026-08-16 09:53:26.903237', NULL, '2026-08-16 09:53:26.903237', NULL);
...
-- ----------------------------
-- (no seed rows for non-boot stacks)
