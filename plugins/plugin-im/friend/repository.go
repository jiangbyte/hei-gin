...
func (r *repository) CountFriendship(ctx context.Context, userID, userType, friendID, friendType string) int64 {
	var count int64
...
func (r *repository) CountPendingRequest(ctx context.Context, senderID, senderType, receiverID, receiverType string) int64 {
	var count int64
...
func (r *repository) CreateRequest(ctx context.Context, req *imModel.FriendRequest) error {
	return db.DB.WithContext(ctx).Create(req).Error
}

func (r *repository) FindPendingRequestForReceiver(ctx context.Context, requestID, receiverID, receiverType string) (*imModel.FriendRequest, error) {
...
func (r *repository) AcceptRequest(ctx context.Context, req *imModel.FriendRequest, pair1, pair2 *imModel.Friendship) error {
...
func (r *repository) RejectRequest(ctx context.Context, requestID, receiverID, receiverType string) (int64, error) {
...
func (r *repository) ListFriendships(ctx context.Context, userID, userType string) []imModel.Friendship {
...
func (r *repository) ListSysUsers(ctx context.Context, ids []string) []sysUser.SysUser {
	var users []sysUser.SysUser
	db.DB.WithContext(ctx).Model(&sysUser.SysUser{}).Where("id IN ?", ids).Find(&users)
	return users
}

func (r *repository) ListClientUsers(ctx context.Context, ids []string) []cliUser.ClientUser {
	var users []cliUser.ClientUser
	db.DB.WithContext(ctx).Model(&cliUser.ClientUser{}).Where("id IN ?", ids).Find(&users)
	return users
}

func (r *repository) ListPendingIncoming(ctx context.Context, userID, userType string) []imModel.FriendRequest {
...
func (r *repository) ListPendingOutgoing(ctx context.Context, userID, userType string) []imModel.FriendRequest {
	var rows []imModel.FriendRequest
	db.DB.WithContext(ctx).Model(&imModel.FriendRequest{}).
...
func (r *repository) RemoveFriendshipPair(ctx context.Context, userID, userType, friendID, friendType string) (int64, int64, error) {
	tx := db.DB.WithContext(ctx).Begin()
...
func (r *repository) SearchSysUsers(ctx context.Context, like string, limit int) []sysUser.SysUser {
	var users []sysUser.SysUser
...
func (r *repository) SearchClientUsers(ctx context.Context, like string, limit int) []cliUser.ClientUser {
	var users []cliUser.ClientUser
...
func (r *repository) CountBlocks(ctx context.Context, userID, userType, blockedID, blockedType string) int64 {
	var count int64
...
func (r *repository) CreateBlock(ctx context.Context, block *imModel.FriendBlock) error {
	return db.DB.WithContext(ctx).Create(block).Error
}

func (r *repository) DeleteFriendshipForBlock(ctx context.Context, userID, userType, blockedID, blockedType string) {
...
func (r *repository) DeleteBlock(ctx context.Context, userID, userType, blockedID, blockedType string) (int64, error) {
...
func (r *repository) ListBlocks(ctx context.Context, userID, userType string) []imModel.FriendBlock {
...
func (r *repository) UpdateRemark(ctx context.Context, userID, userType, friendID, friendType, remark string) error {
