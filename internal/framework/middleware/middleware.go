...
func AuthWhitelist(extra []string) gin.HandlerFunc {
	builtin := []string{
		...
		"/api/v1/admin/forgot-password/phone",
		"/api/v1/admin/reset-password",
		"/api/v1/admin/reset-password/phone",
		"/api/v1/admin/oauth/*",
		"/api/v1/public/site-footer",
		"/api/v1/portal/login",
		...
		"/api/v1/portal/forgot-password/phone",
		"/api/v1/portal/reset-password",
		"/api/v1/portal/reset-password/phone",
		"/api/v1/portal/oauth/*",
	}
