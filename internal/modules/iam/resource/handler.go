...
func (s *Service) registerRoutes(d *shared.Deps) module.RouteRegistrar {
	return func(api *gin.RouterGroup) {
		...
		api.POST("/v1/admin/sys/resources/create", admin, middleware.RequirePermission(d.Perms, "iam:resource:create", "èµ„æºåˆ›å»º"), s.create)
		api.POST("/v1/admin/sys/resources/update", admin, middleware.RequirePermission(d.Perms, "iam:resource:update", "èµ„æºæ›´æ–°"), s.update)
		api.POST("/v1/admin/sys/resources/delete", admin, middleware.RequirePermission(d.Perms, "iam:resource:delete", "èµ„æºåˆ é™¤"), s.delete)
		api.GET("/v1/admin/sys/resources/detail", admin, middleware.RequirePermission(d.Perms, "iam:resource:detail", "èµ„æºè¯¦æƒ…"), s.detail)
		api.GET("/v1/admin/sys/resources/page", admin, middleware.RequirePermission(d.Perms, "iam:resource:page", "èµ„æºåˆ†é¡µ"), s.page)
		api.GET("/v1/admin/sys/resources/current", admin, s.currentAdmin)
		api.GET("/v1/admin/sys/resources/tree", admin, middleware.RequirePermission(d.Perms, "iam:resource:list", "èµ„æºæ ‘"), s.tree)
		api.POST("/v1/admin/sys/resource-modules/create", admin, middleware.RequirePermission(d.Perms, "iam:resourcemodule:create", "èµ„æºæ¨¡å—åˆ›å»º"), s.createModule)
		api.POST("/v1/admin/sys/resource-modules/update", admin, middleware.RequirePermission(d.Perms, "iam:resourcemodule:update", "èµ„æºæ¨¡å—æ›´æ–°"), s.updateModule)
		api.POST("/v1/admin/sys/resource-modules/delete", admin, middleware.RequirePermission(d.Perms, "iam:resourcemodule:delete", "èµ„æºæ¨¡å—åˆ é™¤"), s.deleteModule)
		api.GET("/v1/admin/sys/resource-modules/detail", admin, middleware.RequirePermission(d.Perms, "iam:resourcemodule:detail", "èµ„æºæ¨¡å—è¯¦æƒ…"), s.detailModule)
		api.GET("/v1/admin/sys/resource-modules/page", admin, middleware.RequirePermission(d.Perms, "iam:resourcemodule:page", "èµ„æºæ¨¡å—åˆ†é¡µ"), s.pageModule)
		...
		api.GET("/v1/admin/permission-registry", admin, middleware.RequirePermission(d.Perms, "iam:resource:grant", "èµ„æºæŽˆæƒ"), s.permissionRegistry)
		api.POST("/v1/admin/resource-permissions", admin, middleware.RequirePermission(d.Perms, "iam:resource:grant", "èµ„æºæŽˆæƒ"), s.bindResourcePermissions)
		api.POST("/v1/admin/client-resource-permissions", admin, middleware.RequirePermission(d.Perms, "iam:resource:grant", "èµ„æºæŽˆæƒ"), s.bindClientResourcePermissions)
		api.POST("/v1/admin/sys/resource-buttons/create", admin, middleware.RequirePermission(d.Perms, "iam:resource:create", "èµ„æºåˆ›å»º"), s.createButton)
		api.POST("/v1/admin/sys/resource-buttons/update", admin, middleware.RequirePermission(d.Perms, "iam:resource:update", "èµ„æºæ›´æ–°"), s.updateButton)
		api.POST("/v1/admin/sys/resource-buttons/delete", admin, middleware.RequirePermission(d.Perms, "iam:resource:delete", "èµ„æºåˆ é™¤"), s.deleteButton)
		api.GET("/v1/admin/sys/resource-buttons/page", admin, middleware.RequirePermission(d.Perms, "iam:resource:list", "èµ„æºåˆ†é¡µ"), s.pageButton)
	}
}
