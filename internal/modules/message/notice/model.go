...
func (Notice) TableName() string { return "msg_notice" }

// NoticeRead 通知已读记录实体，对应表 msg_notice_read。
//
// Author: Charlie
...
func (NoticeRead) TableName() string { return "msg_notice_read" }
