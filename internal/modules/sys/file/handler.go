...
func (s *Service) registerRoutes(d *shared.Deps) module.RouteRegistrar {
	return func(api *gin.RouterGroup) {
		...
		api.POST("/v1/admin/sys/file/upload", admin, middleware.RequirePermission(d.Perms, "sys:file:upload", "æ–‡ä»¶ä¸Šä¼ "), s.upload)
		api.POST("/v1/admin/sys/file/delete", admin, middleware.RequirePermission(d.Perms, "sys:file:delete", "æ–‡ä»¶åˆ é™¤"), s.delete)
		api.POST("/v1/admin/sys/file/update", admin, middleware.RequirePermission(d.Perms, "sys:file:update", "æ–‡ä»¶æ›´æ–°"), s.update)
		api.GET("/v1/admin/sys/file/detail", admin, middleware.RequirePermission(d.Perms, "sys:file:detail", "æ–‡ä»¶è¯¦æƒ…"), s.detail)
		api.GET("/v1/admin/sys/file/page", admin, middleware.RequirePermission(d.Perms, "sys:file:page", "æ–‡ä»¶åˆ†é¡µ"), s.page)
		api.POST("/v1/admin/sys/file/list_by_ids", admin, middleware.RequirePermission(d.Perms, "sys:file:detail", "æ–‡ä»¶æ‰¹é‡æŸ¥è¯¢"), s.listByIDs)
		api.GET("/v1/admin/sys/file/download", admin, middleware.RequirePermission(d.Perms, "sys:file:url", "æ–‡ä»¶ä¸‹è½½"), s.download)
		api.POST("/v1/admin/sys/file/url", admin, middleware.RequirePermission(d.Perms, "sys:file:url", "æ–‡ä»¶URL"), s.url)
		api.POST("/v1/admin/sys/file/presigned_url", admin, middleware.RequirePermission(d.Perms, "sys:file:url", "æ–‡ä»¶é¢„ç­¾åURL"), s.presignedURL)
